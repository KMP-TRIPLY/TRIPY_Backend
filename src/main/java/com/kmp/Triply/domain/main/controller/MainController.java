...
public class MainController {
    ...
    public ResponseEntity<ApiResponse<DashboardResponse>> getDashboard(@AuthenticationPrincipal Long userId) {
    ...
    @GetMapping("/d-day")
    public ResponseEntity<ApiResponse<DDayResponse>> getDDay(@AuthenticationPrincipal Long userId) {
