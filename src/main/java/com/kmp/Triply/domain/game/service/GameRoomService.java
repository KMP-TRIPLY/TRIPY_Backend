...
public class GameRoomService {
    ...
    public GameRoomJoinResponse joinRoom(Long userId, Long roomId, GameRoomJoinRequest request) {
        ...
        Team team = teamRepository.findOfRoom(gameRoom.getId());
    ...
    public List<TeamMemberResponse> getRoomMembers(Long roomId) {
        return teamMemberRepository.findAllByTeamIdAndIsActiveTrue(teamRepository.findOfRoom(roomId).getId()).stream()
